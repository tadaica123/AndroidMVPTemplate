...
public class CircleButton extends android.support.v7.widget.AppCompatImageView {
    ...
    protected void onDraw(Canvas canvas) {
        canvas.drawCircle(centerX, centerY, (float)pressedRingRadius + animationProgress, focusPaint);
        canvas.drawCircle(centerX, centerY, (float) outerRadius - pressedRingWidth, circlePaint);
        super.onDraw(canvas);
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            color = a.getColor(R.styleable.CircleButton_color, color);
            pressedRingWidth = (int) a.getDimension(R.styleable.CircleButton_pressedRingWidth, pressedRingWidth);
            a.recycle();
        }
