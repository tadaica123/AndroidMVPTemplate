...
public class MyButton extends AppCompatButton implements View.OnTouchListener {
    ...
    private void init(Typeface tf) {
        ...
        mTextButtonColor = resources.getColor(R.color.black);
        mTextButtonPressedColor = resources.getColor(R.color.black);
        setTextColor(mTextButtonColor);
        ...
        if (tf != null) {
            Typeface typeFace = CustomFontLoader.getTypeface(getContext(), CustomFontLoader.ARIAL);
        ...
        for (int i = 0; i < typedArray.getIndexCount(); i++) {
            ...
            switch (attr) {
                ...
                case R.styleable.MyButton_shadowHeight:
                    ...
                    break;
                case R.styleable.MyButton_cornerRadius:
                    ...
                    break;
                case R.styleable.MyButton_borderWidth:
                ...
                case R.styleable.MyButton_textColor:
                    mTextButtonColor = typedArray.getColor(attr, getResources().getColor(R.color.black));
                    textColorTemp = mTextButtonColor;
                    setTextColor(mTextButtonColor);
                    break;
                case R.styleable.MyButton_textPressedColor:
                    mTextButtonPressedColor = typedArray.getColor(attr, getResources().getColor(R.color.black));
                    break;
                case R.styleable.MyButton_buttonDrawable:
                    tempDrawable = typedArray.getDrawable(attr);
                    isHaveDrawable = true;
                    break;
                case R.styleable.MyButton_buttonDrawableAlign:
                    tempAlign = typedArray.getInt(attr, ALIGN_LEFT);
                    break;
                case R.styleable.MyButton_paddingLeft:
                    ...
                    break;
                case R.styleable.MyButton_paddingRight:
                    ...
                    break;
                case R.styleable.MyButton_paddingTop:
                    ...
                    break;
                case R.styleable.MyButton_paddingBottom:
                    ...
                    break;
                case R.styleable.MyButton_isSetSelected:
